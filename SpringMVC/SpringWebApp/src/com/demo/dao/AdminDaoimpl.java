...
public class AdminDaoimpl implements AdminDao {
	...
	public boolean save(Admin admin) {
		...
		return JdbcTemplate.update("INSERT INTO springdb.ADMIN(nombre, cargo, fechacreacion) "
	...
	public boolean update(Admin admin) {
		// TODO Auto-generated method stub
		return JdbcTemplate.update("UPDATE SPRINGDB.ADMIN SET CARGO=:cargo, NOMBRE=:nombre,"
				+ " FECHACREACION=:fechaCreacion WHERE IDAD=:idAd", 
				new BeanPropertySqlParameterSource(admin))==1;
	}
	@Override
	public boolean delete(int id) {
		// TODO Auto-generated method stub
		return JdbcTemplate.update("DELETE FROM SPRINGDB.ADMIN "
				+ "WHERE IDAD=:idAd", new MapSqlParameterSource("idAd", id))==1;
	}
	...
	public int[] saveAll(List<Admin> admins) {
		...
		return JdbcTemplate.batchUpdate("INSERT INTO springdb.ADMIN(idAd, nombre, cargo, fechacreacion) "
				+ "VALUES (:idAd, :nombre, :cargo, :fechaCreacion)", batchValues);
	}
}